...
export default class approveteachers extends Component {
  ...
  render() {
    ...
    return (
      ...
      {this.state.classes.map(item  => {
          if(  item.userlevel == 'teacher' && item.approvedorrehected == 'pending') 
            return   <View   key={item.id}   style={{ flexDirection: "row", alignSelf: "center" }} > 
                      ...
                      <Text       style={{
                        ...
                        <Text       style={{
                                ...
                                fontSize: 15,
                                fontWeight: "900",
                              }} >Phone no : , {item.phoneno }</Text>      
                       <Text       style={{
                                color: "black",
                                fontSize: 15,
                                fontWeight: "900",
                              }} >Index no : , {item.index }</Text>    
